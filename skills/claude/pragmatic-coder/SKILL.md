...
Use `/pragmatic-coder` in Claude Code. Follow applicable `CLAUDE.md` instructions and Claude Code permission and memory rules; use its available tools for inspection, edits, and verification.
