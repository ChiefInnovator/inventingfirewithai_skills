...
Use `/travel-like-a-local` in Claude Code with its available research and connected travel tools. Follow applicable `CLAUDE.md` instructions and permission and memory rules.
